...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://ios-release-preview-1.preview.emergentagent.com')
...
class TestCreateCheckoutSession:
    ...
    def test_checkout_weekly_plan(self):
        ...
        response = requests.post(
            ...
            json={
                "plan_type": "weekly",
                "origin_url": "https://ios-release-preview-1.preview.emergentagent.com"
            }
        )
