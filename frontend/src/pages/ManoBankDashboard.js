              ...
              {showHelpPanel && (
                <div className="absolute right-0 top-12 w-80 bg-white rounded-2xl shadow-2xl border border-gray-100 z-50 overflow-hidden">
                  <div className="p-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
                    ...
                    <p className="text-sm text-blue-100">Estamos aquí para ti 24/7</p>
                  </div>
                  <div className="p-4 space-y-3">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Chat instantáneo</p>
                      </div>
                    </button>
                    <button 
                      onClick={() => { window.open('mailto:soporte@manobank.es'); setShowHelpPanel(false); }}
                      className="w-full p-3 bg-blue-50 rounded-xl text-left hover:bg-blue-100 transition-colors flex items-center gap-3"
                    >
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">soporte@manobank.es</p>
                      </div>
                    </button>
                  </div>
                  <div className="p-4 border-t border-gray-100 bg-gray-50">
                    ...
                    <div className="space-y-2">
                      {['¿Cómo hago una transferencia?', '¿Cómo bloqueo mi tarjeta?', '¿Cómo contacto con mi gestor?'].map((q, i) => (
                        <button 
                          key={i}
                          onClick={() => { setShowHelpPanel(false); setActiveSection('ajustes'); toast.info('Abriendo centro de ayuda...'); }}
                          className="w-full p-2 bg-white rounded-lg text-left text-sm text-gray-700 hover:bg-gray-100 flex items-center justify-between"
                        >
                          {q}
