  ...
  const documents = [
    {
      ...
      icon: Briefcase,
      filename: 'ManoProtect_Plan_de_Negocio_CONFIDENCIAL_2025.md',
      size: '72 KB',
      pages: '120 páginas',
      color: 'indigo',
      highlights: [
    ...
    },
    {
      ...
      icon: TrendingUp,
      filename: 'ManoProtect_Financial_Model_CONFIDENCIAL_2025.md',
      size: '10 KB',
      pages: '25 páginas',
      color: 'emerald',
      highlights: [
    ...
    },
    {
      ...
      icon: FileText,
      filename: 'ManoProtect_Pitch_Deck_CONFIDENCIAL_2025.md',
      size: '23 KB',
      pages: '11 slides',
      color: 'orange',
      highlights: [
    ...
    },
    {
      ...
      icon: Users,
      filename: 'ManoProtect_Dossier_B2B_CONFIDENCIAL_2025.md',
      size: '9 KB',
      pages: '47 páginas',
      color: 'blue',
      highlights: [
