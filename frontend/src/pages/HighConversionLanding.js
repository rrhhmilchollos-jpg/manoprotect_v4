      ...
      <section className="py-16 sm:py-20 bg-white" data-testid="testimonials-section">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500">Tranquilidad y seguridad garantizadas.</p>
          </div>
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {[
              ...
              { text: 'Mi hija lleva el Sentinel J al cole y las zonas seguras me avisan cuando llega. Sin cámara ni internet. Solo seguridad. Perfecto.', name: 'Laura M.', role: 'Madre', city: 'Valencia', img: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=60&h=60&fit=crop&crop=face' },
              ...
              <Reveal key={i} delay={i * 100}>
                <div className="bg-slate-50 rounded-2xl p-6 border border-gray-100 hover:shadow-md transition-shadow" data-testid={`testimonial-${i}`}>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div><p className="font-bold text-gray-900 text-sm">{t.name} – {t.role}</p><p className="text-xs text-gray-400">{t.city}</p></div>
                  </div>
                </div>
              </Reveal>
            ))}
