/**
 * ManoProtect - Sentinel X para Adultos
 * SEO optimizada: botón SOS personal, dispositivo emergencia adultos
 */
...
const SentinelXAdultos = () => {
  ...
  const schemaFAQ = {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      { "@type": "Question", "name": "¿Cómo funciona el botón SOS para adultos?", "acceptedAnswer": { "@type": "Answer", "text": "Al pulsar el botón SOS físico durante 3 segundos, el Sentinel X envía tu ubicación GPS exacta a hasta 3 contactos de emergencia y realiza una llamada automática. También puedes activar el SOS de forma discreta sin que nadie lo note." } },
      { "@type": "Question", "name": "¿Se puede usar en deporte y trabajo?", "acceptedAnswer": { "@type": "Answer", "text": "Sí. El Sentinel X tiene certificación IP68 + 5ATM (resistente al agua hasta 50m), carcasa de titanio y batería de 5 días. Es perfecto para running, ciclismo, senderismo, trabajo en campo o cualquier actividad al aire libre." } },
      { "@type": "Question", "name": "¿Quién recibe la alerta cuando se pulsa el botón SOS?", "acceptedAnswer": { "@type": "Answer", "text": "Hasta 3 contactos que tú elijas. Reciben una notificación push con tu ubicación exacta, un SMS y una llamada automática. Puedes configurar contactos diferentes para situaciones laborales y personales." } },
      { "@type": "Question", "name": "¿Tiene resistencia al agua?", "acceptedAnswer": { "@type": "Answer", "text": "Sí. Certificación IP68 + 5ATM. Puedes nadar, ducharte y practicar deportes acuáticos sin quitarte el Sentinel X. Resistente a polvo, arena y golpes." } }
    ]
  };
  ...
  const useCases = [
    { icon: <Dumbbell className="w-7 h-7" />, title: "Deporte y Aventura", desc: "Running, ciclismo, senderismo, montaña. El Sentinel X resiste agua, golpes y condiciones extremas. Si te caes o te pierdes, un toque activa la emergencia con tu ubicación exacta. Ideal para deportistas solitarios.", color: "bg-emerald-100 text-emerald-600" },
    { icon: <Briefcase className="w-7 h-7" />, title: "Entorno Laboral", desc: "Trabajadores en campo, repartidores, comerciales, visitadores. El botón SOS discreto permite pedir ayuda sin alertar a terceros. Cumple con normativas de prevención de riesgos laborales (PRL).", color: "bg-blue-100 text-blue-600" },
    { icon: <MapPin className="w-7 h-7" />, title: "Viajes y Desplazamientos", desc: "Ideal para quienes viajan solos o se desplazan frecuentemente. Funciona con 4G LTE en toda Europa. Si te ocurre algo en una ciudad desconocida, tus contactos recibirán tu ubicación exacta al instante.", color: "bg-purple-100 text-purple-600" },
    { icon: <Heart className="w-7 h-7" />, title: "Seguridad Personal", desc: "Para situaciones de acoso, violencia o inseguridad. El modo SOS invisible envía alertas sin que nadie lo note. Grabación automática de audio como prueba. Protección 24/7 en cualquier situación.", color: "bg-red-100 text-red-600" }
  ];

  const features = [
    { icon: <Bell className="w-6 h-6" />, title: "Botón SOS Físico Discreto", desc: "Botón lateral integrado en el diseño. Actívalo con una pulsación larga de 3 segundos. Nadie notará que has pedido ayuda. Envía ubicación GPS y llama a tus contactos automáticamente." },
    { icon: <MapPin className="w-6 h-6" />, title: "Ubicación GPS Inmediata", desc: "GPS multi-banda con precisión de 2-5 metros. Tu ubicación se comparte al instante con tus contactos de emergencia. Funciona en interiores y exteriores." },
    { icon: <Phone className="w-6 h-6" />, title: "Llamadas a 3 Contactos", desc: "Al activar el SOS, el Sentinel X llama automáticamente a tus 3 contactos de emergencia en orden. Si el primero no contesta, llama al segundo, y así sucesivamente." },
    { icon: <Droplets className="w-6 h-6" />, title: "IP68 + 5ATM", desc: "Resistente a inmersiones de hasta 50 metros. Apto para natación, surf, duchas y cualquier condición meteorológica extrema." },
    { icon: <Heart className="w-6 h-6" />, title: "Monitor Cardíaco 24/7", desc: "Sensor de ritmo cardíaco continuo con alertas de anomalías. SpO2 para medir la saturación de oxígeno en sangre. Datos disponibles en la app." },
    { icon: <Battery className="w-6 h-6" />, title: "5 Días de Batería", desc: "Batería optimizada para uso intensivo. 5 días reales sin cargar. Carga magnética rápida: 0 a 100% en 90 minutos." }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        ...
        <meta name="description" content="Sentinel X para adultos, con botón SOS físico, llamadas automáticas y geolocalización inmediata. Seguridad personal para tu vida diaria y deporte." />
        ...
        <meta property="og:description" content="Seguridad personal con botón SOS físico. Llamadas automáticas, GPS y diseño discreto. Para trabajo y deporte." />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8">
                Discreto, resistente y siempre contigo. El Sentinel X es tu dispositivo de seguridad
                personal para el día a día, el trabajo y el deporte. Un toque en el botón SOS
                envía tu ubicación y llama a tus contactos de emergencia automáticamente.
              </p>
              ...
              <div className="flex items-center gap-6 text-sm text-gray-400">
                <span className="flex items-center gap-1"><CheckCircle className="w-4 h-4 text-emerald-500" /> Envío gratis</span>
      ...
      {/* Use Cases */}
      <section className="py-16 bg-white" data-testid="usecases-adultos">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Para tu vida diaria, trabajo y deporte</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">El Sentinel X se adapta a cualquier situación. Un dispositivo de seguridad discreto que no compromete tu estilo.</p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {useCases.map((uc, i) => (
              <div key={i} className="p-6 bg-gray-50 rounded-2xl border border-gray-100 hover:shadow-lg transition-shadow">
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 ${uc.color}`}>{uc.icon}</div>
                <h3 className="font-bold text-gray-900 mb-2 text-lg">{uc.title}</h3>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Características Técnicas</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((f, i) => (
              <div key={i} className="p-5 bg-white rounded-xl border border-gray-200">
                <div className="w-10 h-10 bg-slate-100 rounded-lg flex items-center justify-center text-slate-600 mb-3">{f.icon}</div>
      ...
      {/* Testimonials */}
      <section className="py-16 bg-white" data-testid="testimonials-adultos">
        <div className="max-w-7xl mx-auto px-4">
      ...
      {/* FAQ */}
      <section className="py-16 bg-gray-50" data-testid="faq-adultos">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="space-y-4">
            {[
              ...
              { q: "¿Quién recibe la alerta cuando se pulsa el botón SOS?", a: "Hasta 3 contactos que tú configures. Reciben notificación push con tu ubicación en mapa, un SMS con coordenadas y una llamada automática. Puedes tener perfiles diferentes para trabajo y personal." },
              ...
              { q: "¿Funciona en el extranjero?", a: "Sí. El Sentinel X tiene eSIM 4G LTE que funciona en toda Europa. Si viajas por trabajo o turismo, tu seguridad personal está garantizada con la misma calidad que en España." },
              { q: "¿Es discreto? ¿Parece un reloj normal?", a: "Sí. El Sentinel X tiene un diseño premium minimalista que parece un smartwatch de alta gama. Nadie sabrá que es un dispositivo de seguridad personal salvo que tú lo digas." }
            ].map((faq, i) => (
      ...
      <section className="py-16 bg-gradient-to-r from-slate-800 to-slate-900 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            El Sentinel X es el compañero de seguridad que necesitas. Discreto, potente y siempre listo.
          </p>
          <Link to="/sentinel-x">
          ...
          <p className="text-sm text-gray-400 mt-4">Envío gratis | 30 días de prueba | Garantía 2 años</p>
        </div>
      </section>
