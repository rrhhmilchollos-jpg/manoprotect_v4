...
const products = [
  {
    ...
    features: [
      ...
      'Botón SOS invisible (pulsación larga)',
      'Grabación en la nube (modelo Premium)',
      'Batería 5 días',
  ...
  },
  {
    ...
    features: [
      ...
      '8 correas intercambiables',
      'Batería 4 días',
      'Resistente al agua IP67',
      'Sin cámara ni acceso a internet',
    ],
    useCases: ['Colegio y actividades extraescolares', 'Parque y juegos al aire libre', 'Excursiones escolares', 'Vacaciones familiares'],
  },
  {
    name: 'Sentinel S',
    slug: '/sentinel-s',
    ...
    color: 'violet',
    features: [
      'Cerámica + acabado rose gold',
      'GPS + GLONASS',
      '4G LTE',
      'Botón SOS silencioso',
      'Alerta anti-retirada',
      'Sirena integrada 120dB',
      'Batería 3 días',
      'Correas intercambiables pastel',
    ],
