...
const FloatingWhatsApp = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50" data-testid="floating-whatsapp">
      {/* Popup message */}
      {isOpen && (
        <div className="absolute bottom-20 right-0 w-72 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden animate-in slide-in-from-bottom-5 fade-in duration-300">
      ...
      <button
        onClick={handleClick}
        className="group relative w-16 h-16 bg-green-500 hover:bg-green-600 rounded-full shadow-2xl flex items-center justify-center transition-all hover:scale-110"
