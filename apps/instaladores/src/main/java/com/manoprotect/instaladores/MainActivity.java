package com.manoprotect.instaladores;
...
/**
 * ManoProtect Instaladores - WebView App with Auto-Update
 */
public class MainActivity extends Activity {
    ...
    private void checkForUpdates() {
        String json = "{\"app_name\":\"instaladores\",\"current_version\":\"" + CURRENT_VERSION + "\",\"current_build\":" + CURRENT_BUILD + "}";
